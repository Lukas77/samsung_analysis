...
4. the variables were appropriately named
5. the average of each variable for each activity and each subject were calculated
...
* Subject: The number of the subject of the measurements
* Activity: Activity by which the measurements where taken
